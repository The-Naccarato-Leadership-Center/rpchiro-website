<? include("../includes/template/header.inc.php");?>
   ...
   <?php
	...
	$Subject = "Santa Barbara Register ".$name;
	$Message = "Name: ".$name."\n"."Contact: ".$email."\n"."Phone: ".$phone."\n"."Address: ".$address."\n"."Address2: ".$address2."\n"."Attendees: ".$attendees."\n"."CCA Member: ".$ccamember;
	   ...
	   mail($webbirg2, $Subject, $Message);
           ...
           print "</div>";
           print "</h1>";
           print "<div class=\"text\">If you have any questions about the seminar, contact Elizabeth Wisniewski DC at 805-285-2712.</div>";

        } else {
     ?>

			<h1>
			  <div align="center">  Santa Barbara District March 23rd Seminar Signup Form</div>
			</h1>
			<div class="text">Fill out the following form to register for our 2 hour seminar on March 23rd.  Join us and get 2 hours of CE credit's while you learn the 5 critical steps to building a practice full of patients who stay, pay and refer!  </div>
			<form method="post" action="santabarbara.php">
	<div id="form">
