<? include("../includes/template/header.inc.php");?>
   ...
   <?php
	...
	$Subject = "Riverside Register ".$name;
	$Message = "Name: ".$name."\n"."Contact: ".$email."\n"."Phone: ".$phone."\n"."Address: ".$address."\n"."Address2: ".$address2."\n"."Attendees: ".$attendees."\n"."CCA Member: ".$ccamember;
	   ...
	   mail($webbirg2, $Subject, $Message);
           ...
           print "</div>";
           print "</h1>";
           print "<div class=\"text\">If you have any questions about the seminar, contact Dr. Lorraine Giliberto, DC at (951) 784-2600 or at (951) 536-3654.</div>";

        } else {
     ?>

			<h1>
			  <div align="center">  Riverside County District June 28th Seminar Signup Form</div>
			</h1>
			<div class="text">Fill out the following form to register for our 2 hour seminar on June 28th.  Join us and get 2 hours of CE credit's while you learn the 5 critical steps to building a practice full of patients who stay, pay and refer!  </div>
			<form method="post" action="riverside_signup.php">
	<div id="form">
