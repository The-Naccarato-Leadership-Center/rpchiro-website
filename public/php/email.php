...

{
   ...
   print "&nbsp;&nbsp;&nbsp;";
   print "<A HREF=\"http://www.rpchiro.com/php/unsubscribes.php?username=" . $username . "&password=" . $password . "\">Unsubscribed</A>"; 
   print "</form>";
      

   $Query = "select email, subscribe, source from email where subscribe = 'S'";
